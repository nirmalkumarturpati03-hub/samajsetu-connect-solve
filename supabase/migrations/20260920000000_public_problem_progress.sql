-- Privacy-safe lifecycle progress for citizen and administrator problem views.
-- It exposes only aggregate workflow state and participant count, never names,
-- exact locations, contact data, task evidence, or assignment notes.
...
returns table (
  ...
  assignment_status text, participant_count integer
